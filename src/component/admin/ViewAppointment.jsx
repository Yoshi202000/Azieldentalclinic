...
function ViewAppointment() {
  ...
  const [expandedImage, setExpandedImage] = useState(null); // Add state for expanded image
  ...
  // Function to handle clicking on payment image
